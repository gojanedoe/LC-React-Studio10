    ...
    return (
      <Content>
        <div>
          ...
          <p>{`${name} has ${experience} years of experience as a stylist and primary serves ${clientele.join(
            " and "
          )}. Originally from ${from}, you will likely find ${name} in or around ${faveSTL} on weekends. Favorite activities include ${loves}.`}</p>
